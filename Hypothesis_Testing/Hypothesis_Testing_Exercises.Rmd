...
## **Exercise 6: Visualizing the Z-Distribution**
6. Create a plot of the standard normal distribution and shade the area corresponding to a Z-critical value of 1.96 for a two-tailed test (representing a 5% significance level). Highlight the rejection regions.

```{r}
library(ggplot2)

# TODO Your code here
# Create a sequence of Z values
