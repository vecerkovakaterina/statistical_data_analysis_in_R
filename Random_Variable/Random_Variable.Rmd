...
### 6. **Discrete Random Variable Example**
   - **Example:** Use a specific discrete random variable (e.g., the number of heads in a coin toss) to illustrate PMF and CDF calculations.
   - **Exercise:** Calculate and plot the PMF and CDF for this example.

### 7. **Continuous Random Variable Example**
   - **Example:** Use a specific continuous random variable (e.g., the height of individuals) to illustrate PDF and CDF calculations.
   - **Exercise:** Calculate and plot the PDF and CDF for this example.

### 8. **Advanced Exercises**
   - **Exercise 1:** Calculate the PMF and CDF for a custom discrete random variable.
   - **Exercise 2:** Calculate the PDF and CDF for a custom continuous random variable.
   - **Exercise 3:** Compare and contrast the PMF/PDF and their corresponding CDFs.
