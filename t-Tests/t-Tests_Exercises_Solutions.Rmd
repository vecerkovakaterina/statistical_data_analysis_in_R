---
title: "t-Tests: Exercises Solutions"
...
x_bar <- mean(differences)  # Mean of differences
s <- sd(differences)         # Standard deviation of differences
...
# Decision
if (abs(t) > t_critical) {
   print("Reject H0: The therapy has a significant effect on anxiety levels.")
} else {
   print("Fail to reject H0: The therapy does not have a significant effect.")
}

# Paired t-test using t.test()
...
if (p_value < alpha_1) {
   ...
   print("Fail to reject H0 at 1% significance level.")
}
```
